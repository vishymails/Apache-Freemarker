...
public class MainTest2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        cfg.setClassForTemplateLoading(MainTest2.class, "templates");
        ...
        input.put("title", "Apache Freemarker example");
        ...
        Template template = cfg.getTemplate("AssociatedTemplate-2.ftl");
